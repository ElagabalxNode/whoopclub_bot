*Этот проект создавался вечерами с помощью ChatGpt 4o, я не умею програмировать, но оно работает*
# 🤖 WhoopClub Bot
...
- `Купить абонемент` — покупка абонемента на 4 или 10 тренировок с уведомлением админов

### 👨‍✈️ Администраторы
- `/admin` — панель админа:
  - Создание тренировок через интерактивный календарь (только вторники и четверги)
